...
public class AddEmployeeSteps extends CommonMethods {
	...
	public void verify_the_data_from_frontend_and_backend(){
		...
		System.out.println("FirstName"+GlobalVariables.dbFirstName);
		System.out.println("MiddleName"+GlobalVariables.dbMiddleName);
		System.out.println("LastName"+GlobalVariables.dbLastName);
